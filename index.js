...
const photosPaginatedRoutes = require("./src/routes/photosPaginatedRoutes");
const photoCategoryRoutes = require("./src/routes/photoCategoryRoutes");
...
app.use("/api/photo-category", photoCategoryRoutes);
...
app.use("/api/photos-new", photosPaginatedRoutes);
